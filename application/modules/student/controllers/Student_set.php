...
//         // Ambil daftar kelas dari database (bisa diatur sesuai kebutuhan)
//         $data['class'] = $this->db->get('class')->result();

//         // Tampilkan view dengan daftar kelas
//         $this->load->view('student/student_list', $data);
//     }

//     public function filterByKelas() {
//         $class_id = $this->input->post('class_id');
//         $data['student'] = $this->Student_model->getSiswaByKelas($class_id);

//         // Tampilkan data siswa dalam bentuk tabel atau sesuai kebutuhan
//         $this->load->view('student/hasil_filter', $data);
//     }
...
//             $checked = $this->input->post('student_id');
//             $checked_id = [];
//             foreach ($checked as $row) {
//                 array_push($checked_id, $row);
//             }
//             $this->load->model('student_model');
//             $this->student_model->remove($checked_id);
...
//         <strong>Pilih setidaknya satu data</strong> <button type="button" class="close" data-dismiss="alert" aria-label="Close">
//           <span aria-hidden="true">&times;</span></button></div>');
//           redirect('student');
//         }
//     } 
