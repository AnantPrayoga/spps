			...
			<div class="col-xs-12">
				<div class="box"> 
					<div class="box-header">
						...
						<!-- <form action="<?= base_url('student/filterByKelas') ?>" method="post">
    ...
    <button type="submit">Filter</button>
						...
						<div class="box-tools">
							...
							<div class="input-group input-group-sm" style="width: 250px;">
								<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="Nama Siswa/NIS"' ?> class="form-control" required>
					...
					<!-- <form action="<?= base_url('manage/student/student_set/deleteItems')?>" method="post">
              <div class="card">
              <div class="card-header">
              <button type="submit" name="deleteall" class="btn btn-danger btn-sm" onclick="return confirmDeleted()"><i class="fas fa-trash"></i> Hapus Data </button>
              <a href="<?= base_url('student/printSelected')?>" class="btn btn-info btn-sm" id="printSelected"><i class="fas fa-print"></i> Print</a>
              </div> 
            </div> -->
										...
										foreach ($student as $row):
											...
											<tr>
												...
												<td>
													...
													<!-- <a href="<?php echo site_url('manage/student/printPdf/' . rawurlencode($row['student_id'])) ?>" class="btn btn-success btn-xs view-pdf" data-toggle="tooltip" title="Cetak Kartu"><i class="fa fa-print"></i></a> -->
...
$(function(){    
	$('.view-pdf').on('click',function(){
		var pdf_link = encodeURIComponent($(this).attr('href'));
